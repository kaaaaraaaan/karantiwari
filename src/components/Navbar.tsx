            ...
            <div className="container mx-auto px-4 md:px-6 h-16 flex items-center max-w-7xl">
                ...
                <div className="hidden md:grid md:grid-cols-3 w-full items-center">
                    ...
                    <nav className="flex items-center gap-6">
                        <Link href="#about" className="text-sm font-medium hover:text-[#7e22ce] transition-colors">
                            About
                        </Link>
                        <Link href="#work" className="text-sm font-medium hover:text-[#7e22ce] transition-colors">
                            Work
                        </Link>
                        <Link href="#skills" className="text-sm font-medium hover:text-[#7e22ce] transition-colors">
                            Skills
                        </Link>
                    </nav>
