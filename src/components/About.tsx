        ...
        <Section id="about" className="bg-white">
            ...
            <div className="flex flex-col md:flex-row items-center gap-12">
                ...
                >
                    ...
                    <div className="pt-4">
                        <button className="bg-[#8b5cf6] text-white px-8 py-3 rounded-md font-medium hover:bg-[#7c3aed] transition-colors shadow-md">
                            Contact Me
                        </button>
                    </div>
                </motion.div>
                ...
                >
                    ...
                    <div className="absolute top-4 -right-4 w-full h-full bg-[#a855f7] -z-0 rounded-lg transform translate-x-2 translate-y-2 hidden md:block opacity-20"></div>
                    <div className="absolute -bottom-4 -left-4 w-24 h-24 bg-[#7e22ce] -z-0 rounded-full opacity-10"></div>
                </motion.div>
            </div>
        </Section>
    );
