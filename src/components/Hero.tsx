...
export function Hero() {
    return (
        <section className="relative py-8 md:py-16 overflow-hidden bg-[#F3F1F6]">
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-4">
                    <div className="flex-1 flex flex-col md:flex-row items-center md:items-start gap-8">
                        ...
                        <motion.div
                            ...
                            className="hidden md:flex flex-col gap-6 pt-4 text-gray-600"
                        >
                            <a href="https://www.linkedin.com/in/karan-tiwari-2019/" target="_blank" rel="noopener noreferrer" className="hover:text-[#7e22ce] transition-colors"><Linkedin size={24} /></a>
                            <a href="https://www.instagram.com/kaaaaraaaan/" target="_blank" rel="noopener noreferrer" className="hover:text-[#7e22ce] transition-colors"><Instagram size={24} /></a>
                            <a href="https://www.facebook.com/kaaaaraaaan" target="_blank" rel="noopener noreferrer" className="hover:text-[#7e22ce] transition-colors"><Facebook size={24} /></a>
                        </motion.div>
                        ...
                        >
                            <h1 className="font-serif text-4xl md:text-6xl font-bold text-[#0f172a]">
                                Er. Karan Tiwari
                            </h1>
                            ...
                            {/* Mobile Socials */}
                            <div className="flex md:hidden justify-center gap-6 text-gray-600 py-2">
